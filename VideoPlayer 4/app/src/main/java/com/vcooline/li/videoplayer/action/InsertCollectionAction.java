...
public class InsertCollectionAction {
    ...
    public InsertCollectionAction(Activity mActivity,ActionBack mactionBack){
        this.activity = mActivity;
        this.actionBack = mactionBack;
        this.aq = new AQuery(activity);
    }

    public void insertCollection(String materialId){
        String callUrl = UrlTool.INSERTCOLLECTION;
