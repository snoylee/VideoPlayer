...
public class TouxiangFragment extends Fragment implements  View.OnClickListener{

    private SketchFragment allFragment,nanFragment,nvFragment;
    private TabButton nan,nv;

    public TouxiangFragment() {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        allFragment = SketchFragment.newInstance("01","04", null, false);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.nan:
                ...
                if(nanFragment == null){
                    nanFragment = SketchFragment.newInstance("01","04", "09", false);
                }
            ...
            case R.id.nv:
                ...
                nv.setSelected(true);
                if(nvFragment == null){
                    nvFragment = SketchFragment.newInstance("01","04", "10", false);
                }
