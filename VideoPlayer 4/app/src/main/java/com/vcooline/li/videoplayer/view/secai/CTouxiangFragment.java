...
public class CTouxiangFragment extends Fragment implements  View.OnClickListener{

    private SketchFragment allFragment,nanFragment,nvFragment;
    private TabButton nan,nv;

    public CTouxiangFragment() {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        allFragment = SketchFragment.newInstance("03","04", null, false);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.nan:
                ...
                if(nanFragment == null){
                    nanFragment = SketchFragment.newInstance("03","04", "09", false);
                }
            ...
            case R.id.nv:
                ...
                nv.setSelected(true);
                if(nvFragment == null){
                    nvFragment = SketchFragment.newInstance("03","04", "10", false);
                }
